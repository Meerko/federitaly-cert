...
export default function NotFound() {
  ...
  return (
    <section className="section-padding relative container flex items-center justify-center">
      ...
      >
        <span className="text-primary/10 text-[12rem] font-bold select-none sm:text-[16rem] md:text-[25rem] lg:text-[32rem]">
          404
        </span>
      </motion.div>
      ...
      >
        ...
        >
          ...
          <br />
          Può darsi che l’indirizzo sia cambiato o che il contenuto sia stato aggiornato.
        </motion.p>
        ...
        <Button
          ...
          >
            <Link href="/">
              Torna alla homepage
              <div className="bg-background border-background/10 grid size-5.5 place-items-center rounded-full border">
                <ChevronRight className="size-4 transition-transform group-hover:translate-x-0.25" />
              </div>
            </Link>
          </Button>
